...
export default function TicketsCreation() {
    return (
        <div class="grid gap-6 mb-6 md:grid-cols-3">
        <div>
           <label for="TicketType" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ticket type</label>
           <input type="text" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ticket type " required/>
       </div>
       <div>
       ...
       <div>
           <label for="Number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price</label>
